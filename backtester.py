...
Yahoo 730‑day intraday limit respected.
"""

# Dummy env vars so import works without Discord/Groq secrets
import os
...
BACKTEST_CONFIG = {
    "start_date": "2024-08-01",        # within Yahoo 730‑day intraday window
    "end_date": "today",               # "today" or "YYYY‑MM‑DD"
    "initial_balance": 1000.0,
    "fee_pct": 0.1,                    # % per fill
    "slippage_pct": {                  # per order
        "top_10": 0.02,
        "other": 0.05
    },
...
class BacktestEngine:
    ...
    def run(self):
        ...
        for i, current_date in enumerate(self.dates):
            ...
            if signal is not None: self.open_trades.append(signal)
        self.save_results()
